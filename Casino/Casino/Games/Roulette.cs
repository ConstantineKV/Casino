...
namespace Casino
{
    class Roulette : Game
    {
        ...
        public override void stopGame(Object source, System.Timers.ElapsedEventArgs e)          //Игра остановлена, рассчитать победителя
        {
            ...
            if (players[best_player_number].Luck < croupier.Mastery)
                victory_number = 0;
            Console.WriteLine();
        ...
        //операторы
        public static Roulette operator +(Roulette roulette, Player player)
        {
            roulette.newPlayer(player);
            return roulette;
        }
    }
}
